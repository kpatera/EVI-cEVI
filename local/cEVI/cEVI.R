...
tmp_cEVI_co=deviant(new_cases = Colombia[1:170],cum = TRUE, lag_max = 40,method="cEVI")
...
graph_in<-evi.graphs.comb(tmp_cEVI_in,tmp_EVI_in,EVI1.lab = "cEVI", EVI2.lab = "EVI",EVI3.lab = "cEVI+",EVI.country = "India")
